...
function ConsumeRowView (displayValueUtil) {
  ...
  this.consumeMessagesTextField.value = 'Typically, create the consumer instance, then consume';
	this.consumeMessagesTextField.setEditable(true)
...
ConsumeRowView.prototype.getConsumeMessagesTextField = function(){
	return this.consumeMessagesTextField.value;
};

ConsumeRowView.prototype.setConsumeMessagesTextField = function(consumeMessages){
	this.consumeMessagesTextField.value = consumeMessages;
};
